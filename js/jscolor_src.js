...
var jscolor = {
	...
	build : function() {
		...
		'.cross{background-image:url('+(IE?'/images/cross.gif':'data:image/gif;base64,'+cross+'')+')}'+
		'.arrow{background-image:url('+(IE?'/images/arrow.gif':'data:image/gif;base64,'+arrow+'')+')}'+
		'.tw{background-image:url('+(IE?'/images/tw.png':'data:image/png;base64,'+tw+'')+')}'+
		'.tb{background-image:url('+(IE?'/images/tb.png':'data:image/png;base64,'+tb+'')+')}';
